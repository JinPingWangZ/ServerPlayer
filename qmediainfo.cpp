...
{
    _lib = new QLibrary(qApp->applicationDirPath() + "/mediainfo/MediaInfo.dll");
    _lib->load();
...
QString QMediaInfo::VideoResolution() const {
    wchar_t *propH=(wchar_t*)L"Height";
    wchar_t *propW=(wchar_t*)L"Width";
...
QString QMediaInfo::VideoFrameRate() const {
    wchar_t *prop=(wchar_t*)L"FrameRate/String";
    return QString::fromStdWString(Get(1, 0, prop, 1, 0));
}

QString QMediaInfo::VideoCodec() const {
    wchar_t *prop=(wchar_t*)L"InternetMediaType";
    wchar_t *propF=(wchar_t*)L"Format";
    QString codec;
...
QString QMediaInfo::Title() const {
    wchar_t *prop=(wchar_t*)L"Title";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}

QString QMediaInfo::TitleMore() const {
    wchar_t *prop=(wchar_t*)L"Title/More";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}

QString QMediaInfo::Domain() const {
    wchar_t *prop=(wchar_t*)L"Domain";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}

QString QMediaInfo::Collection() const {
    wchar_t *prop=(wchar_t*)L"Collection";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}

QString QMediaInfo::Season() const {
    wchar_t *prop=(wchar_t*)L"Season";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}

QString QMediaInfo::Movie() const {
    wchar_t *prop=(wchar_t*)L"Movie";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}
...
QString QMediaInfo::FileSize() const {
    wchar_t *prop=(wchar_t*)L"FileSize/String";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}

QString QMediaInfo::FormatExt() const {
    wchar_t *prop=(wchar_t*)L"Format/Extensions";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}

QString QMediaInfo::CompleteName() const {
    wchar_t *prop=(wchar_t*)L"CompleteName";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}

QString QMediaInfo::Filename() const {
    wchar_t *prop=(wchar_t*)L"FileName";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}

QString QMediaInfo::FileExtension() const {
    wchar_t *prop=(wchar_t*)L"FileExtension";
    return QString::fromStdWString(Get(0, 0, prop, 1, 0));
}
